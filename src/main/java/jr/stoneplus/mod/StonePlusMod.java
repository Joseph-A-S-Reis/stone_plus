...
@Mod("stone_plus")
public class StonePlusMod {
	public static final Logger LOGGER = LogManager.getLogger(StonePlusMod.class);
	public static final String MODID = "stone_plus";

	public StonePlusMod(FMLJavaModLoadingContext context) {
